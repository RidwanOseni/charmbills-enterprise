/* @ts-self-types="./charms_protocol_scanner.d.ts" */
console.log("🚀 RUNTIME CHECK: Loaded charms_protocol_scanner.js - Build Date: May 15");
 ...
 * @returns {any}
 */
function extractAndVerifySpell(tx, mock) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./charms_protocol_scanner_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/charms_protocol_scanner_bg.wasm`;
